...
```sh
git clone https://github.com/banxiafire/JSC370.git
cd JSC370
```
...
```sh
https://github.com/banxiafire/JSC370
```
...
```sh
commit: 02c026bf9fe4c19bd76d2d41e0999bc0dd7b3ee9
Author: banxiafire <104917595+banxiafire@users.noreply.github.com>
Date: Wed Jan 14 13:44:24 2026 -0500
```
